...
cnxn = pyodbc.connect('DRIVER={ODBC Driver 17 for SQL Server};Server=DCT-SQL-01;Database=DAVE;Trusted_Connection=yes;')
# Use below connection string when deploying to Ubuntu as part of the Docker image
# cnxn = pyodbc.connect('DRIVER={FreeTDS};Server=DCT-SQL-01;Port=1433;Database=DAVE;UID=immunetolerance\\dct-sqlprod-01-sql-s;PWD=Fb59roVytFFZAcMbHAdw;TDS_Version=8.0')
